...
WebUI.click(findTestObject('LivingTree/MyProfile/ActivationButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('LivingTree/ActivationPageLink/ActivationPage'), 0)
...
WebUI.click(findTestObject('LivingTree/MyProfilePageLink/ManageDataButton'))
