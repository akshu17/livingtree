...
WebUI.waitForElementPresent(findTestObject('LivingTree/PostIconConversationPage/CreatePostAllIcon'), 1)

WebUI.click(findTestObject('LivingTree/PostIconConversationPage/ConversationCamerIcon'))
...
WebUI.click(findTestObject('LivingTree/PostIconConversationPage/ConversationVideoIcon'))
...
WebUI.click(findTestObject('LivingTree/PostIconConversationPage/ConversationFileIcon'))
