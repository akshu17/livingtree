...
WebUI.openBrowser('https://maple.livingtree.com/login?brand=livingtreedfghj')

WebUI.setText(findTestObject('LivingTree/LoginPage/LoginPageEmailAdressTextBox'), 'teacheraa@mailinator.com')
