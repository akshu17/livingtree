...
WebUI.click(findTestObject('LivingTree/MyProfile/ManageDataButton'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('LivingTree/ManageDataLink/ManageDataPage'), 0)

WebUI.click(findTestObject('LivingTree/ManageDataLink/SelectSchoolDropDown'))
