...
WebUI.click(findTestObject('LivingTree/CreateNewLayer/MynetworkAaschool'))
...
WebUI.verifyElementClickable(findTestObject('LivingTree/CreateNewLayer/CreateNewLayerSaveButton'))

WebUI.click(findTestObject('LivingTree/CreateNewLayer/CreateNewLayerSaveButton'))
