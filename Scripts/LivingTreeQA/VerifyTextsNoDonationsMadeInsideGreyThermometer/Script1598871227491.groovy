...
WebUI.waitForElementPresent(findTestObject('LivingTree/GivePage/GivePageCompaign'), 0)

WebUI.waitForElementPresent(findTestObject('LivingTree/GivePage/NoDonationmadeTab'), 0)
