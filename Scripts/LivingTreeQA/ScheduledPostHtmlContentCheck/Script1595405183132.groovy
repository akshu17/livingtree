...
WebUI.mouseOver(findTestObject('LivingTree/SchedulePost/TypeMessageBox'))
...
WebUI.verifyElementClickable(findTestObject('LivingTree/SchedulePost/a_Ryms'))

WebUI.click(findTestObject('LivingTree/SchedulePost/a_Ryms'))
