...
WebUI.setText(findTestObject('LivingTree/ConversationPage/ConversationPageInputSearch'), 'post')

WebUI.delay(1)

WebUI.mouseOver(findTestObject('LivingTreeProduction/ConversationPage/SearchIconEngage'))

WebUI.click(findTestObject('LivingTreeProduction/ConversationPage/SearchIconEngage'))

WebUI.waitForElementVisible(findTestObject('LivingTree/MyNetworkPage/LivingtreeLoaderIcon'), 0)

WebUI.click(findTestObject('LivingTree/SearchBox/SearchIconCancelButton'))
