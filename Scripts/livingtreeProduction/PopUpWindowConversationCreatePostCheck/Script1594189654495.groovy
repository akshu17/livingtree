...
WebUI.click(findTestObject('LivingTree/ConversationPage/PopUpBoxIcon'))

WebUI.waitForElementClickable(findTestObject('LivingTree/ConversationPage/ShareMessageInputBox'), 5)
