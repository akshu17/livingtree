...
WebUI.waitForElementPresent(findTestObject('LivingTree/ConversationPage/MoreLink'), 0)

WebUI.click(findTestObject('Edlio/MyNetworkPage/MyNetworkIcon'))

WebUI.waitForElementPresent(findTestObject('LivingTree/MyNetworkPage/MoreLink'), 1)
