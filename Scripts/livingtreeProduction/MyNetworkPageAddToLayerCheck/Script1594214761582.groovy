...
WebUI.verifyElementClickable(findTestObject('LivingTreeProduction/CreateNewLayer/CreateNewLayerInputSaveButton'))

WebUI.click(findTestObject('LivingTreeProduction/CreateNewLayer/CreateNewLayerInputSaveButton'))
