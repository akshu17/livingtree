...
WebUI.waitForElementPresent(findTestObject('LivingTree/DeletePopUpCheck/DeleteCancelButton'), 5)

WebUI.click(findTestObject('LivingTree/DeletePopUpCheck/DeleteCancelButton'))

WebUI.scrollToPosition(0, 0)

WebUI.click(findTestObject('LivingTree/SeeWhatsNewWidget/SeeWhatsNewWidget'))
