...
WebUI.waitForElementVisible(findTestObject('LivingTree/CreatePostPage/AddFileButton'), 10)

WebUI.click(findTestObject('LivingTree/CreatePostPage/AddFileButton'))
