...
WebUI.click(findTestObject('LivingTree/VerifyEditPrincipleButton/EditPencil'))

WebUI.waitForElementPresent(findTestObject('LivingTree/VerifyEditPrincipleButton/EditPrinciplePage'), 1)

WebUI.click(findTestObject('LivingTree/VerifyEditPrincipleButton/ButtonCancel'))
