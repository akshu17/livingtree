...
WebUI.mouseOver(findTestObject('Edlio/ConversationPage/SearchIconEdlio'))

WebUI.click(findTestObject('Page_Edlio Engage teacher115 mailinator/SearchIconEdlio'))
