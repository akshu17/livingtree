...
WebUI.waitForElementPresent(findTestObject('EdlioProduction/ConversationPopUP/AddMemberPopUpIcin'), 3)

WebUI.click(findTestObject('EdlioProduction/ConversationPopUP/AddMemberPopUpIcin'))

WebUI.click(findTestObject('Edlio/ConversationPopUp/ConversationSearchBox'))
