...
WebUI.verifyElementPresent(findTestObject('EdlioProduction/CreateNewLayer/ChanduInternationalSchool'), 0)

WebUI.click(findTestObject('EdlioProduction/CreateNewLayer/ChanduInternationalSchool'))

WebUI.delay(5)

WebUI.waitForElementVisible(findTestObject('EdlioProduction/MyNetwork/DailogBoxEditButtonEdlioProd'), 
    2)

WebUI.delay(1)

WebUI.click(findTestObject('EdlioProduction/MyNetwork/DailogBoxEditButtonEdlioProd'))
