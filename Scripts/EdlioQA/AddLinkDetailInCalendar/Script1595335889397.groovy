...
WebUI.click(findTestObject('LivingTree/Calendar/CreateEventButton'))

WebUI.verifyElementVisible(findTestObject('LivingTree/Calendar/AddDetailsButton'), FailureHandling.STOP_ON_FAILURE)
