...
WebUI.waitForElementPresent(findTestObject('Edlio/ConversationPage/AddMemberConversationpage'), 3)

WebUI.click(findTestObject('Edlio/ConversationPopUp/Add MemberPopUpIcon'))
