...
WebUI.waitForElementPresent(findTestObject('LivingTree/InboxcStructureCheck/ComposeMessage'), 0)
...
WebUI.click(findTestObject('LivingTree/InboxcStructureCheck/DeleteButton'))
