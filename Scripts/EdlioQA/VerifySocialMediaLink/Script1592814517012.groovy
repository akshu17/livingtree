...
WebUI.waitForElementVisible(findTestObject('Edlio/ConversationPage/SocialMediaLinkAppStore'), 10)

WebUI.waitForElementVisible(findTestObject('Edlio/ConversationPage/SocialMediaLinkPlayStore'), 10)

WebUI.waitForElementVisible(findTestObject('Edlio/ConversationPage/widget'), 10)
