...
WebUI.click(findTestObject('Edlio/MyNetworkPage/MyNetworkPageWalkGroup'))

WebUI.click(findTestObject('Edlio/MyNetworkPage/MyNetworkPageAddParentButton'))

WebUI.waitForElementVisible(findTestObject('LivingTree/MyNetworkPage/MyNetworkPageLoader'), 0)
